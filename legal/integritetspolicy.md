...
| Uppgift | När den behandlas | Syfte |
|---|---|---|
| E-postadress och kontouppgifter | När du skapar och använder ett konto | Skapa konto, autentisera dig och administrera tjänsten |
| Visningsnamn och profilbild | Om du väljer att lägga till dem | Visa din profil i annonser, omdömen och chattar |
| Swish-nummer | Om du väljer att spara det | Göra det möjligt för en köpare som har startat en chatt med dig att betala dig |
| Annonsuppgifter | När du skapar en annons | Publicera och hantera din annons |
| Konversationer och meddelanden | När du använder chatten | Möjliggöra kommunikation mellan köpare och säljare samt hantera trygghetsärenden |
| Omdömen | När ett omdöme lämnas | Skapa förtroende mellan användare |
...
## 4. Hur uppgifter visas och delas
